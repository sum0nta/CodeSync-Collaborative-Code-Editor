...
class ProductionAIService {
  constructor() {
    ...
    console.log('AI_PROVIDER:', this.provider);
  ...
  async testConnection() {
    try {
      ...
      console.warn('Ollama connection failed. Make sure Ollama is running.');
      console.warn('This is normal during startup, Ollama will be available shortly.');
    }
  }
